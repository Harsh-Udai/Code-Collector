    ...
    <form method="post">
        ...
        <div class="d-flex justify-content-center">
          <div class="card" style="width: 18rem;margin:30px">
            <img src="HarshU.jpeg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Harsh Udai</h5>
              <p class="card-text">Connect:</p>
              <p class="card-text">Harshudai@jklu.edu.in</p>
            </div>
          </div>
        
        <div class="card" style="width: 18rem;margin:30px">
          <img src="YashM.jpeg" class="card-img-top" alt="..." height="348px">
          <div class="card-body">
            <h5 class="card-title">Yash R. Mishra</h5>
            <p class="card-text">Connect:</p>
            <p class="card-text">Yashmishra@jklu.edu.in</p>
        ...
        <div class="d-flex justify-content-center">
        <div class="card" style="width: 18rem;margin:30px">
          <img src="YashG.jpeg" class="card-img-top" alt="..." height="348px">
          <div class="card-body">
            <h5 class="card-title">Yash Goyal</h5>
            <p class="card-text">Connect:</p>
            <p class="card-text">Yashgoyal@jklu.edu.in</p>
          </div>
        </div>
        <div class="card" style="width: 18rem;margin:30px">
          <img src="Varun.jpeg" class="card-img-top" alt="..."  height="348px">
          <div class="card-body">
            <h5 class="card-title">Varun Rawat</h5>
            <p class="card-text">Connect:</p>
            <p class="card-text">Varunrawat@jklu.edu.in</p>
          </div>
        </div>
        </div>
    </body>
