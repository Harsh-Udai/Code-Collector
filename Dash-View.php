...
if(isset($_POST["delete"])){
  ...
  $result1=mysqli_query($con,"Delete from datatable where title='".$title."' and password='".$_SESSION["password"]."' ");
  if($result1==$val){
    header("Location: AllCodes.php");
  }
}
else{
...
<html>
  ...
  ?>" readonly>
        ...
        <div class="d-flex justify-content-center">
          <button type="button" id="copy" style="width:250px;margin-bottom: 10px;margin-right:10px" class="btn btn-dark">Copy the Code</button>
          <button type="submit" id="delete" name="delete" style="width:250px;margin-bottom: 10px;" class="btn btn-dark">Delete the Code</button>
        </div>
        <div class="d-flex justify-content-center">
