...
if(isset($_POST["delete"])){
  ...
  $result2=mysqli_query($con,"Delete from datatable where title='".$title."' and password='".$_SESSION["password"]."' ");
  if($result2==$val){
  ...
  ?>" readonly>
            ...
            <div class="d-flex justify-content-center">
              <div class="form-row" style="margin-top: 10px;">
                <div>
                  ...
                  <input class="form-control" type="text" style="width:750px; margin-bottom: 10px;" placeholder="<?php 
                  echo $title;?>                 
                  " readonly>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-center">
          <div class="form-group">
            ...
            <textarea class="form-control" name="data" style="width:750px;" id="exampleFormControlTextarea1" rows="20" required readonly><?php
                echo $string;
            ?>
        ...
        <div class="d-flex justify-content-center">
          <button type="button" id="copy" style="width:242.5px;margin-bottom: 10px;margin-right:10px" class="btn btn-dark">Copy the Code</button>
          <button type="submit" id="delete" name="delete" style="width:242.5px;margin-right: 10px;margin-bottom: 10px;" class="btn btn-dark">Delete the Code</button>
          <a href='Data-Edit.php?title=<?php echo $title ?>'><button type="button" id="Edit" name="edit" style="width:242.5px;margin-bottom: 10px;" class="btn btn-dark">Edit </button>
        </div>
        <div class="d-flex justify-content-center">
      ...
      <script type="text/javascript">
        ...
        document.getElementById("copy").onclick=function(){
          var dta=document.getElementById("exampleFormControlTextarea1");
          dta.select();
